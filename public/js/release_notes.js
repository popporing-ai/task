...
const RELEASE_NOTES = [
  {
    version: '2.22.1',
    date: '2026-08-26',
    title: '브랜드 가이드 내용을 원본 v1.1로 갱신',
    sections: [
      {
        kind: 'update',
        title: '대외 커뮤니케이션 원본 최신본 반영',
        items: [
          {
            text: '브랜드 메시지 가이드 내용을 원본 기준(v1.1)에 맞췄습니다. 회사 소개 문장 사용법을 명사구 구조로 정교화하고, 제조나 국방 밖 사업(환경, ODA, 교육, 해양)은 한정어를 떼는 기준을 넣었습니다.',
          },
          {
            text: '쓸 수 있는 수치에 설립 연도(2016년), 상장 시점(2023년 7월, 조달 307억 원)을 추가하고, 고객사, 특허, 재계약은 무엇을 세는 값인지 기준을 밝히도록 정리했습니다. "무엇을 알릴지" 구역도 추가했습니다.',
          },
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        items: [
          {
            text: '브랜드 가이드의 슬로건, 각 구역, 각 표, AI 지침 구역을 화면에서 바로 수정할 수 있습니다. 관리자는 현재 버전에서 각 카드의 수정, 삭제 버튼과 구역 추가 버튼을 씁니다. 새 버전을 발행하지 않고 현재 버전을 바로 고칩니다.',
          },
          {
            text: '표기 사전은 표 단위로 수정하거나 표를 새로 추가할 수 있습니다. 표 안에 줄을 추가해 항목을 늘립니다. 과거 버전은 열람만 가능합니다.',
          },
        ],
      },
    ],
  },
  {
    version: '2.21.0',
    date: '2026-08-26',
    title: '브랜드 가이드 구역화, 표기 사전 표, 구역별 복사',
    sections: [
      {
        kind: 'design',
        title: '읽기 쉽게 구역으로 나눔',
        items: [
          {
            text: '문장 나열이던 브랜드 가이드를 구역별 카드로 나눴습니다. 메시지 방향과 대외 커뮤니케이션 규칙은 주제별 카드로, 슬로건은 강조 카드로 보여줍니다.',
          },
        ],
      },
      {
        kind: 'feature',
        title: '구역별 복사와 표기 사전 표',
        items: [
          {
            text: '슬로건, 각 구역, 각 표에 복사 버튼을 넣었습니다. 필요한 부분만 눌러 복사할 수 있습니다. AI 지침 원문은 구역별 복사와 전체 복사를 함께 제공합니다.',
          },
          {
            text: '자주 틀리는 표기와 용어를 표기 사전으로 정리했습니다. 제품명 16종, 외래어, 맞춤법, 띄어쓰기, 숫자 단위, 군 자료 용어 등 14개 표입니다. 관리자는 발행 화면에서 표에 줄을 추가해 항목을 늘릴 수 있습니다.',
          },
          {
            text: 'AI 지침 원문은 채널별 세부 작성 규칙을 빼고 전체 대외 커뮤니케이션 공통 규칙만 담았습니다. 클로드코드 등 AI 작업 첫머리에 붙여 쓰는 용도입니다.',
          },
        ],
      },
    ],
  },
  {
    version: '2.20.0',
    date: '2026-08-26',
    title: '브랜드 메시지 가이드 첫 내용 반영',
    sections: [
      {
        kind: 'update',
        title: '대외 커뮤니케이션 기준 v1.0 적용',
        items: [
          {
            text: '브랜드 메시지 가이드에 슬로건, 메시지 방향, 대외 커뮤니케이션 규칙, AI 지침 원문을 채웠습니다. 회사 수식어는 "제조·국방 피지컬 AI 기업, 버넥트"로 통일했습니다. 직전 표기(더 편하게, 더 안전하게...)와 휴먼 중심 표기는 폐기 목록에 넣었습니다.',
          },
          {
            text: 'AI 지침 원문은 상단 복사 버튼으로 통째로 복사해 AI 초안 작성 첫 부분에 붙여 쓸 수 있습니다.',
          },
        ],
      },
    ],
  },
  {
    version: '2.19.0',
    date: '2026-08-18',
    title: 'R&R을 엑셀 업무분장표와 같은 표로 변경, 사람별 필터 추가',
    sections: [
      {
        kind: 'design',
        title: '카드 대신 표 형태로 표시',
        items: [
          {
            text: 'R&R을 담당자 카드 대신 엑셀 업무분장표와 같은 표로 바꿨습니다. 정기 업무분장은 No, 파트, 대분류, 업무명, 주요 내용, 주기, 정 담당, 부 담당 열로, 솔루션 리드는 솔루션명, 리드 담당자, 상태·비고 열로 보여줍니다. 업무명을 클릭하면 상세 팝업이 열립니다.',
          },
        ],
      },
      {
        ...
        items: [
          {
            text: '표 위의 담당자 버튼(전체, 안영선, 남병진, 구지향)으로 본인 업무만 걸러 볼 수 있습니다. 정 담당 기준으로 필터링됩니다.',
          },
        ],
      },
      {
        ...
        items: [
          {
            text: '과거 R&R 버전(예: v1.0.0)은 보관본으로 열람만 가능하며 현재 버전으로 되돌릴 수 없습니다. 버전 선택 목록과 화면 상단에 보관본임을 표시합니다.',
          },
        ],
      },
    ],
