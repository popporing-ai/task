...
const ALLOWED_TABLES = ['tasks', 'timeline_items', 'content_items', 'rrr_items', 'task_categories', 'products', 'subtasks', 'comments', 'tags', 'task_tags', 'attachments', 'checklists', 'checklist_items', 'task_issues', 'task_dependencies', 'team_goals', 'feedbacks', 'kpi_records', 'users', 'performance_scores', 'meetings', 'performance_alerts'];
